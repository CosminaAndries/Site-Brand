...
let selectBox=document.querySelector('.options');
let searchBox=document.querySelector('.search-box');
let phoneBox=document.querySelector('.phone-box');
let selectedOption=document.querySelector('.selected-option div');
let options=null;
const countries = [
...
for (country of countries){
    const option=`<li class="option">
     <div>
        ...
        <span class="nameCountry">${country.name}</span>
 </div>
...
function selectOption(){
    console.log(this);
    let flag=this.querySelector('.iconify').cloneNode(true);
    let code=this.querySelector('strong').cloneNode(true);
    selectedOption.innerHTML="";
    selectedOption.append(flag,code);
    phoneBox.value=code.innerText;
...
searchBox.addEventListener('input',function(){
  ...
  for(option of options){
   let isMatched=option.querySelector('.nameCountry').innerText.toLowerCase().includes(search);
